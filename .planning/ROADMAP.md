...
- [ ] **Phase 1: Spec and Schema** - Language-agnostic API spec, shared test vectors, and schema DDL establishing the cross-language contract
...
|-------|----------------|--------|-----------|
| 1. Spec and Schema | 0/2 | Not started | - |
| 2. Go SDK | 0/2 | Not started | - |
